import { ChangeDetectionStrategy, Component, ElementRef, Input, OnDestroy, signal, ViewChild, AfterViewInit, EventEmitter, Output } from '@angular/core';

@Component({
  selector: 'kn-bottom-sheet-core',
  imports: [],
  templateUrl: './bottom-sheet-core.component.html',
  styleUrl: './bottom-sheet-core.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class KnBottomSheetCoreComponent implements OnDestroy, AfterViewInit {
